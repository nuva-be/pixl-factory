# Adopt Distributed Tracing for Public API Observability: Trace Spans Include
...
1. SHOULD: Trace spans SHOULD include business-relevant metadata (user_id, tenant_id, request_id) as span attributes for correlation

## Policy Block

- SHOULD Trace spans SHOULD include business-relevant metadata (user_id, tenant_id, request_id) as span attributes for correlation
