# Standardize Server-Sent Events (SSE) for Real-Time Configuration and Runtime State Updates: Sse Implementations Support
...
1. MAY: SSE implementations MAY support event filtering or subscription patterns to reduce bandwidth for clients interested in specific event types

## Policy Block

- MAY SSE implementations MAY support event filtering or subscription patterns to reduce bandwidth for clients interested in specific event types
