# Adopt Distributed Tracing for Public API Observability: Tracing Implementations Propagate
...
1. MUST: Tracing implementations MUST propagate trace context across service boundaries using W3C Trace Context or OpenTelemetry standards

## Policy Block

- MUST Tracing implementations MUST propagate trace context across service boundaries using W3C Trace Context or OpenTelemetry standards
