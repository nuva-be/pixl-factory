# Standardize Service Boundary Logging for Observability: Service Boundary Logging
...
1. SHOULD: Service boundary logging SHOULD use structured logging formats (JSON, key-value pairs) rather than unstructured text to enable automated log analysis

## Policy Block

- SHOULD Service boundary logging SHOULD use structured logging formats (JSON, key-value pairs) rather than unstructured text to enable automated log analysis
