# Adopt Distributed Tracing for Public API Observability: Tracing Instrumentation Not
...
1. MUST_NOT: Tracing instrumentation MUST NOT log sensitive data (passwords, tokens, PII) in span attributes or events

## Policy Block

- MUST_NOT Tracing instrumentation MUST NOT log sensitive data (passwords, tokens, PII) in span attributes or events
