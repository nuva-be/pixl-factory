# Adopt Distributed Tracing for Public API Observability: Implementations Create Child
...
1. SHOULD: API implementations SHOULD create child spans for significant internal operations (database queries, external service calls, computation-heavy operations)

## Policy Block

- SHOULD API implementations SHOULD create child spans for significant internal operations (database queries, external service calls, computation-heavy operations)
