# Standardize Server-Sent Events (SSE) for Real-Time Configuration and Runtime State Updates: Route Handlers Properly
...
1. MUST: Route handlers MUST properly close SSE connections and clean up resources when clients disconnect or execution completes

## Policy Block

- MUST Route handlers MUST properly close SSE connections and clean up resources when clients disconnect or execution completes
