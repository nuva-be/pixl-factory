# Adopt Distributed Tracing for Public API Observability: Public External Endpoints
...
1. MUST: All public/external API endpoints MUST instrument entry and exit points with distributed tracing spans

## Policy Block

- MUST All public/external API endpoints MUST instrument entry and exit points with distributed tracing spans
