...
1. MUST_NOT: Service boundary logs MUST NOT include sensitive data (passwords, tokens, PII) unless explicitly redacted or masked

## Policy Block

- MUST_NOT Service boundary logs MUST NOT include sensitive data (passwords, tokens, PII) unless explicitly redacted or masked
