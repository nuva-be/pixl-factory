# Standardize Server-Sent Events (SSE) for Real-Time Configuration and Runtime State Updates: Runtime State Updates
...
1. MUST: Runtime state updates and configuration changes MUST be delivered to clients using Server-Sent Events (SSE) protocol

## Policy Block

- MUST Runtime state updates and configuration changes MUST be delivered to clients using Server-Sent Events (SSE) protocol
